...
create index if not exists idx_design_intents_project_id on public.design_intents(project_id);
...
create index if not exists idx_code_versions_status on public.code_versions(status);
...
create index if not exists idx_execution_logs_project_id on public.execution_logs(project_id);
create index if not exists idx_execution_logs_stage on public.execution_logs(stage);
...
create index if not exists idx_ifc_files_project_id on public.ifc_files(project_id);
...
drop policy if exists "users_own_design_intents" on public.design_intents;
...
drop policy if exists "users_own_code_versions" on public.code_versions;
...
drop policy if exists "users_own_execution_logs" on public.execution_logs;
...
drop policy if exists "users_own_ifc_files" on public.ifc_files;
